...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin HSCB_TextureFX [{Brightness = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_5> [{Value = InputFloat<ShaderFX.InputValueFloat.i5,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_5>}]}, {Contrast = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_4> [{Value = InputFloat<ShaderFX.InputValueFloat.i4,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_4>}]}, {Control = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_6> [{Value = InputFloat4<ShaderFX.InputValueFloat4,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_6>}]}, {Hue = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Default_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Default_0>}]}, {HueCycles = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Default_1> [{Value = InputFloat<ShaderFX.InputValueFloat.i1,PerUpdate>}]]}]}, {Value = GetVarFloat<Default_1>}]}, {Saturation = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Default_2> [{Value = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}]]}]}, {Value = GetVarFloat<Default_2>}]}, {SaturationBalance = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Default_3> [{Value = InputFloat<ShaderFX.InputValueFloat.i3,PerUpdate>}]]}]}, {Value = GetVarFloat<Default_3>}]}]
...
@P Saturation: mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Default_2> [{Value = InputFloat<ShaderFX.InputValueFloat.i2,PerUpdate>}]]}]}, {Value = GetVarFloat<Default_2>}]
...
@P Contrast: mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_4> [{Value = InputFloat<ShaderFX.InputValueFloat.i4,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_4>}]
...
//
#line 385 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_TextureFXEffect_af0caf2bcc0517960730bb35f5f83f69.hlsl"
...
//
#line 284 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_TextureFXEffect_af0caf2bcc0517960730bb35f5f83f69.hlsl"
...
{
    streams.Input_4_id106 = Compute_id46();
}
...
{
    streams.Default_2_id124 = Compute_id82();
}
...
{
    return streams.Default_2_id124;
}
