...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Liquish_TextureFX [{ColorA = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_2> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_2>}]}, {ColorB = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_3> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_3>}]}, {ColorC = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_4> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_4>}]}, {Scale = mixin DoFloat2 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat2<Input_1> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}]]}]}, {Value = GetVarFloat2<Input_1>}]}, {Time = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_0>}]}]
...
@P ColorB: mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Default_3> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}]]}]}, {Value = GetVarFloat4<Default_3>}]
...
//
#line 341 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_TextureFXEffect_457d1bc49d35a6ec87c824185885e779.hlsl"
...
//
#line 305 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_TextureFXEffect_457d1bc49d35a6ec87c824185885e779.hlsl"
...
{
    streams.Default_3_id98 = Compute_id48();
}
