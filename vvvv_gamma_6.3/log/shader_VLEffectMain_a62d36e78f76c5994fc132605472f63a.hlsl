...
//
#line 1189 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_a62d36e78f76c5994fc132605472f63a.hlsl"
...
//
#line 1298 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_a62d36e78f76c5994fc132605472f63a.hlsl"
...
#line 913
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id477 return value>.x; r7.y <- <ComputeDirectLightContribution_id477 return value>.y; r7.z <- <ComputeDirectLightContribution_id477 return value>.z
...
#line 670
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id299 return value>.x; r0.z <- <Compute_id299 return value>.y; r0.w <- <Compute_id299 return value>.z

#line 847
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id478 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id478 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id478 return value>.z
...
{
    streams.Input_1_id207 = Compute_id287();
}
void Compute_id278(inout PS_STREAMS streams)
{
    streams.Input_0_id198 = Compute_id275();
}
...
float3 ComputeEnvironmentLightContribution_id478(inout PS_STREAMS streams)
{
    ...
    return Compute_id299(specularColor, streams.alphaRoughness_id72, streams.NdotV_id74) * streams.envLightSpecularColor_id50;
}
...
{
    float metalness = Compute_id298(streams).r;
...
{
    float glossiness = Compute_id286(streams).r;
...
{
    float4 colorBase = Compute_id273();
