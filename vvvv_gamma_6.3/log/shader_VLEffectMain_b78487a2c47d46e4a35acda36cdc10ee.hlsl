...
//
#line 1219 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_b78487a2c47d46e4a35acda36cdc10ee.hlsl"
...
//
#line 1286 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_b78487a2c47d46e4a35acda36cdc10ee.hlsl"
...
#line 905
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id473 return value>.x; r7.y <- <ComputeDirectLightContribution_id473 return value>.y; r7.z <- <ComputeDirectLightContribution_id473 return value>.z
...
#line 662
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id295 return value>.x; r0.z <- <Compute_id295 return value>.y; r0.w <- <Compute_id295 return value>.z

#line 839
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id474 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id474 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id474 return value>.z
...
{
    streams.Input_1_id205 = Compute_id283();
}
void Compute_id274(inout PS_STREAMS streams)
{
    streams.Input_0_id196 = Compute_id271();
}
...
float3 Compute_id295(float3 specularColor, float alphaR, float nDotV)
{
...
float Compute_id387(inout PS_STREAMS streams)
{
...
float3 Compute_id327(inout PS_STREAMS streams, float3 f0)
{
...
void AfterLightingAndShading_id444()
{
}
...
float3 ComputeEnvironmentLightContribution_id474(inout PS_STREAMS streams)
{
    ...
    return Compute_id295(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
...
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id327(streams, specularColor);
    float geometricShadowing = Compute_id357(streams);
    float normalDistribution = Compute_id387(streams);
...
void PrepareForLightingAndShading_id441()
{
}
...
void Compute_id505(inout PS_STREAMS streams)
{
    ...
    {
        PrepareForLightingAndShading_id441();
    }
    ...
    {
        AfterLightingAndShading_id444();
    }
}
void Compute_id489(inout PS_STREAMS streams)
{
    float metalness = Compute_id294(streams).r;
...
{
    float glossiness = Compute_id282(streams).r;
...
{
    float4 colorBase = Compute_id269();
