...
//
#line 1039 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_28fca8ac221b2daec04059569d78fa60.hlsl"
...
//
#line 1106 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_28fca8ac221b2daec04059569d78fa60.hlsl"
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t0.xxxx, s0, r3.w  // r6.z <- <SampleTextureAndCompare_id62 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r10.zwzz, t0.xxxx, s0, r3.w  // r6.w <- <SampleTextureAndCompare_id62 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r12.xyxx, t0.xxxx, s0, r3.w  // r6.x <- <SampleTextureAndCompare_id62 return value>

#line 511
  mad r3.y, r3.y, r6.x, r5.x  // r3.y <- shadow

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r13.xyxx, t0.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id62 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r13.zwzz, t0.xxxx, s0, r3.w  // r4.z <- <SampleTextureAndCompare_id62 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r14.zwzz, t0.xxxx, s0, r3.w  // r3.z <- <SampleTextureAndCompare_id62 return value>
...
#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r10.xyxx, t0.xxxx, s0, r2.z  // r1.w <- <SampleTextureAndCompare_id62 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r10.zwzz, t0.xxxx, s0, r2.z  // r2.w <- <SampleTextureAndCompare_id62 return value>
...
#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r12.xyxx, t0.xxxx, s0, r2.z  // r2.w <- <SampleTextureAndCompare_id62 return value>

#line 511
      mad r1.w, r2.x, r2.w, r1.w

#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r13.xyxx, t0.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id62 return value>
...
float SampleAndFilter_id69(float3 adjustedPixelPositionWS, float3 adjustedPixelPositionShadowSpace, float2 depthRanges, float4x4 inverseWorldToShadowCascadeUV, bool isOrthographic, bool isDualParaboloid = false)
{
    ...
    {
        float3 kernel[16];
        normalizationFactor = Get7x7FilterKernel_id61(base_uv, st, kernel);
...
float FilterShadow_id55(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[16];
        float normalizationFactor = Get7x7FilterKernel_id61(base_uv, st, kernel);
