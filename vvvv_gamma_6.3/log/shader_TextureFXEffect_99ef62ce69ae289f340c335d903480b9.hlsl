...
@P   - EffectNodeBase.EffectNodeBaseShader: mixin Liquish_TextureFX [{ColorA = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_2> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}]]}]}, {Value = GetVarFloat4<Input_2>}]}, {ColorB = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_3> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color.i1,PerUpdate>}]]}]}, {Value = GetVarFloat4<Input_3>}]}, {ColorC = mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_4> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>}]]}]}, {Value = GetVarFloat4<Input_4>}]}, {Scale = mixin DoFloat2 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat2<Input_1> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}]]}]}, {Value = GetVarFloat2<Input_1>}]}, {Time = mixin DoFloat [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat<Input_0> [{Value = InputFloat<ShaderFX.InputValueFloat,PerUpdate>}]]}]}, {Value = GetVarFloat<Input_0>}]}]
...
@P Scale: mixin DoFloat2 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat2<Input_1> [{Value = InputFloat2<ShaderFX.InputValueFloat2,PerUpdate>}]]}]}, {Value = GetVarFloat2<Input_1>}]
@P ColorA: mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_2> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color,PerUpdate>}]]}]}, {Value = GetVarFloat4<Input_2>}]
...
@P ColorC: mixin DoFloat4 [{Before = mixin ComputeOrder [{Computes = [mixin AssignVarFloat4<Input_4> [{Value = InputFloat4<ShaderFX.InputValueFloat4_Color.i2,PerUpdate>}]]}]}, {Value = GetVarFloat4<Input_4>}]
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 341 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_TextureFXEffect_99ef62ce69ae289f340c335d903480b9.hlsl"
...
//
#line 305 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_TextureFXEffect_99ef62ce69ae289f340c335d903480b9.hlsl"
...
struct PS_STREAMS 
{
    ...
    float2 Input_1_id110;
    float Input_0_id116;
    float4 Input_2_id92;
    float4 Input_3_id98;
    float4 Input_4_id104;
...
{
    streams.Input_4_id104 = Compute_id57();
}
...
{
    streams.Input_2_id92 = Compute_id39();
}
...
{
    streams.Input_1_id110 = Compute_id66();
}
float4 Compute_id63(inout PS_STREAMS streams)
{
    return streams.Input_4_id104;
}
