...
@P   - ColorTransformGroup.Transforms: Stride.Rendering.Images.LuminanceToChannelTransform
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 163 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_ColorTransformGroupEffect_d65078849818a17c2c6172b0feefdca3.hlsl"
...
@G    Pixel => 1639190190522a88ad62e62671ee77a9
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 138 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_ColorTransformGroupEffect_d65078849818a17c2c6172b0feefdca3.hlsl"
...
static float Luma_id6(float3 color)
{
    return max(dot(color, float3(0.299, 0.587, 0.114)), 0.0001);
}
float4 Compute_id4(float4 color)
{
    float4 outColor = color;
    outColor.a = Luma_id6(color.rgb);
    return outColor;
}
