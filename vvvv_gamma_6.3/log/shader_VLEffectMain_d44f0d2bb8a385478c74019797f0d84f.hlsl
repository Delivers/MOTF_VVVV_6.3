...
@P VLEffectParameters.MaterialExtensionShader: Shader_1291069996
...
@C    MaterialIndex_id141 => GBufferOutputSubsurfaceScatteringMaterialIndex.MaterialIndex
...
@C    LightCount_id144 => DirectLightGroupPerView.LightCount.directLightGroups[0]
@C    Lights_id146 => LightDirectionalGroup.Lights.directLightGroups[0]
@C    ShadowMapTextureSize_id148 => ShadowMap.TextureSize.directLightGroups[0]
@C    ShadowMapTextureTexelSize_id149 => ShadowMap.TextureTexelSize.directLightGroups[0]
...
@R    ShadowMapTexture_id147 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: None, Slot: (-1--1)]
@R    ShadowMapTexture_id147 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: None, Slot: (-1--1)]
...
@R    ShadowMapTexture_id147 => ShadowMap.ShadowMapTexture.directLightGroups[0] [Stage: Pixel, Slot: (0-0)]
...
@S    Shader_1291069996 => 292ae5aa54ab3196ee5a5ceccb999b70
...
//   uint MaterialIndex_id141;          // Offset:  416 Size:     4 [unused]
//
// }
//
// cbuffer PerView
...
//   int LightCount_id144;              // Offset:  400 Size:     4 [unused]
//   
...
//
//   } Lights_id146;                    // Offset:  416 Size:    28 [unused]
//   float2 ShadowMapTextureSize_id148; // Offset:  448 Size:     8 [unused]
//   float2 ShadowMapTextureTexelSize_id149;// Offset:  456 Size:     8 [unused]
...
//
#line 1051 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_d44f0d2bb8a385478c74019797f0d84f.hlsl"
...
@G    Pixel => caf3fdec12c05f670d83f7c76a061b91
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float3 WorldScale_id38;            // Offset:  384 Size:    12 [unused]
//   float4 EyeMS_id39;                 // Offset:  400 Size:    16 [unused]
//   uint MaterialIndex_id141;          // Offset:  416 Size:     4
//
// }
//
// cbuffer PerMaterial
...
//   float AspectRatio_id172;           // Offset:  376 Size:     4 [unused]
//   float4 _padding_PerView_Default;   // Offset:  384 Size:    16 [unused]
//   int LightCount_id144;              // Offset:  400 Size:     4
//   
//   struct DirectionalLightData
//   {
//       
...
//       float3 Color;                  // Offset:  432
//
//   } Lights_id146;                    // Offset:  416 Size:    28
//   float2 ShadowMapTextureSize_id148; // Offset:  448 Size:     8
//   float2 ShadowMapTextureTexelSize_id149;// Offset:  456 Size:     8
...
// Name                                 Type  Format         Dim      HLSL Bind  Count
// ------------------------------ ---------- ------- ----------- -------------- ------
// LinearClampCompareLessEqualSampler_id115  sampler_c      NA          NA             s0      1 
// ShadowMapTexture_id147            texture  float4          2d             t0      1 
...
//
#line 1115 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_d44f0d2bb8a385478c74019797f0d84f.hlsl"
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r10.xyxx, t0.xxxx, s0, r3.w  // r6.z <- <SampleTextureAndCompare_id65 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.w, r10.zwzz, t0.xxxx, s0, r3.w  // r6.w <- <SampleTextureAndCompare_id65 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.x, r12.xyxx, t0.xxxx, s0, r3.w  // r6.x <- <SampleTextureAndCompare_id65 return value>

#line 511
  mad r3.y, r3.y, r6.x, r5.x  // r3.y <- shadow

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.x, r13.xyxx, t0.xxxx, s0, r3.w  // r5.x <- <SampleTextureAndCompare_id65 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.z, r13.zwzz, t0.xxxx, s0, r3.w  // r4.z <- <SampleTextureAndCompare_id65 return value>
...
#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r3.z, r14.zwzz, t0.xxxx, s0, r3.w  // r3.z <- <SampleTextureAndCompare_id65 return value>
...
#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r1.w, r10.xyxx, t0.xxxx, s0, r2.z  // r1.w <- <SampleTextureAndCompare_id65 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r10.zwzz, t0.xxxx, s0, r2.z  // r2.w <- <SampleTextureAndCompare_id65 return value>
...
#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r12.xyxx, t0.xxxx, s0, r2.z  // r2.w <- <SampleTextureAndCompare_id65 return value>

#line 511
      mad r1.w, r2.x, r2.w, r1.w

#line 452
      sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r13.xyxx, t0.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id65 return value>
...
#line 798
  ...
  mul r2.xyz, r2.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000)  // r2.x <- <ComputeDirectLightContribution_id209 return value>.x; r2.y <- <ComputeDirectLightContribution_id209 return value>.y; r2.z <- <ComputeDirectLightContribution_id209 return value>.z
...
#line 789
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id160 return value>
...
#line 767
ushr r0.x, r0.y, l(16)  // r0.x <- <GetMaxLightCount_id172 return value>
...
#line 741
mul r0.xyz, r0.xyzx, cb1[0].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id210 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id210 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id210 return value>.z
...
***************************
*************************/
const static int TMaxLightCount_id145 = 1;
...
struct PS_STREAMS 
{
    ...
    float NdotL_id49;
    float NdotV_id72;
    float thicknessWS_id143;
    float3 shadowColor_id142;
    float3 H_id75;
    float NdotH_id76;
    float LdotH_id77;
    float VdotH_id78;
...
cbuffer PerView 
{
    ...
    int LightCount_id144;
    DirectionalLightData Lights_id146[TMaxLightCount_id145];
    float2 ShadowMapTextureSize_id148;
    float2 ShadowMapTextureTexelSize_id149;
...
Texture2D ShadowMapTexture_id147;
...
float Get3x3FilterKernel_id67(float2 base_uv, float2 st, out float3 kernel[4])
{
    ...
    kernel[0] = float3(base_uv + uv0 * ShadowMapTextureTexelSize_id149, uvW0.x * uvW0.y);
    kernel[1] = float3(base_uv + float2(uv1.x, uv0.y) * ShadowMapTextureTexelSize_id149, uvW1.x * uvW0.y);
    kernel[2] = float3(base_uv + float2(uv0.x, uv1.y) * ShadowMapTextureTexelSize_id149, uvW0.x * uvW1.y);
    kernel[3] = float3(base_uv + uv1 * ShadowMapTextureTexelSize_id149, uvW1.x * uvW1.y);
    return 16.0;
}
float Get5x5FilterKernel_id66(float2 base_uv, float2 st, out float3 kernel[9])
{
    ...
    kernel[0] = float3(base_uv + uv0 * ShadowMapTextureTexelSize_id149, uvW0.x * uvW0.y);
    kernel[1] = float3(base_uv + float2(uv1.x, uv0.y) * ShadowMapTextureTexelSize_id149, uvW1.x * uvW0.y);
    kernel[2] = float3(base_uv + float2(uv2.x, uv0.y) * ShadowMapTextureTexelSize_id149, uvW2.x * uvW0.y);
    kernel[3] = float3(base_uv + float2(uv0.x, uv1.y) * ShadowMapTextureTexelSize_id149, uvW0.x * uvW1.y);
    kernel[4] = float3(base_uv + uv1 * ShadowMapTextureTexelSize_id149, uvW1.x * uvW1.y);
    kernel[5] = float3(base_uv + float2(uv2.x, uv1.y) * ShadowMapTextureTexelSize_id149, uvW2.x * uvW1.y);
    kernel[6] = float3(base_uv + float2(uv0.x, uv2.y) * ShadowMapTextureTexelSize_id149, uvW0.x * uvW2.y);
    kernel[7] = float3(base_uv + float2(uv1.x, uv2.y) * ShadowMapTextureTexelSize_id149, uvW1.x * uvW2.y);
    kernel[8] = float3(base_uv + uv2 * ShadowMapTextureTexelSize_id149, uvW2.x * uvW2.y);
    return 144.0;
}
...
{
    const float shadowMapDepth = ShadowMapTexture_id147.SampleLevel(LinearBorderSampler_id114, shadowSpaceCoordinate.xy, 0).r;
    float thickness;
    if (isOrthographic)
    {
...
float Get7x7FilterKernel_id64(float2 base_uv, float2 st, out float3 kernel[16])
{
    ...
    kernel[1] = float3(base_uv + float2(uv1.x, uv0.y) * ShadowMapTextureTexelSize_id149, uvW1.x * uvW0.y);
    kernel[2] = float3(base_uv + float2(uv2.x, uv0.y) * ShadowMapTextureTexelSize_id149, uvW2.x * uvW0.y);
    kernel[3] = float3(base_uv + float2(uv3.x, uv0.y) * ShadowMapTextureTexelSize_id149, uvW3.x * uvW0.y);
    kernel[4] = float3(base_uv + float2(uv0.x, uv1.y) * ShadowMapTextureTexelSize_id149, uvW0.x * uvW1.y);
    kernel[5] = float3(base_uv + uv1 * ShadowMapTextureTexelSize_id149, uvW1.x * uvW1.y);
    kernel[6] = float3(base_uv + float2(uv2.x, uv1.y) * ShadowMapTextureTexelSize_id149, uvW2.x * uvW1.y);
    kernel[7] = float3(base_uv + float2(uv3.x, uv1.y) * ShadowMapTextureTexelSize_id149, uvW3.x * uvW1.y);
    kernel[8] = float3(base_uv + float2(uv0.x, uv2.y) * ShadowMapTextureTexelSize_id149, uvW0.x * uvW2.y);
    kernel[9] = float3(base_uv + float2(uv1.x, uv2.y) * ShadowMapTextureTexelSize_id149, uvW1.x * uvW2.y);
    kernel[10] = float3(base_uv + uv2 * ShadowMapTextureTexelSize_id149, uvW2.x * uvW2.y);
    kernel[11] = float3(base_uv + float2(uv3.x, uv2.y) * ShadowMapTextureTexelSize_id149, uvW3.x * uvW2.y);
    kernel[12] = float3(base_uv + float2(uv0.x, uv3.y) * ShadowMapTextureTexelSize_id149, uvW0.x * uvW3.y);
    kernel[13] = float3(base_uv + float2(uv1.x, uv3.y) * ShadowMapTextureTexelSize_id149, uvW1.x * uvW3.y);
    kernel[14] = float3(base_uv + float2(uv2.x, uv3.y) * ShadowMapTextureTexelSize_id149, uvW2.x * uvW3.y);
    kernel[15] = float3(base_uv + uv3 * ShadowMapTextureTexelSize_id149, uvW3.x * uvW3.y);
    return 2704.0;
}
...
{
    float2 uv = adjustedPixelPositionShadowSpace.xy * ShadowMapTextureSize_id148;
    float2 base_uv = floor(uv + 0.5);
    float2 st = uv + 0.5 - base_uv;
    base_uv *= ShadowMapTextureTexelSize_id149;
    float thickness = 0.0;
    float normalizationFactor = 1.0;

    {
        float3 kernel[16];
        normalizationFactor = Get7x7FilterKernel_id64(base_uv, st, kernel);
...
void CalculateAdjustedShadowSpacePixelPosition_id71(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    ...
    const float4 topRightTexelWS = Project_id57(float4(ShadowMapTextureTexelSize_id149.xy * filterRadiusInPixels, 0.0, 1.0), inverseWorldToShadowCascadeUV);
...
void CalculateAdjustedShadowSpacePixelPositionPerspective_id70(float filterRadiusInPixels, float3 pixelPositionWS, float3 meshNormalWS, float4x4 worldToShadowCascadeUV, float4x4 inverseWorldToShadowCascadeUV, out float3 adjustedPixelPositionWS, out float3 adjustedPixelPositionShadowSpace)
{
    ...
    const float4 topRightTexelWS = Project_id57(float4(shadowMapCoordinate.xy + ShadowMapTextureTexelSize_id149.xy * filterRadiusInPixels, shadowMapCoordinate.z, 1.0), inverseWorldToShadowCascadeUV);
...
{
    return ShadowMapTexture_id147.SampleCmpLevelZero(LinearClampCompareLessEqualSampler_id115, position, positionDepth);
}
void CalculatePCFKernelParameters_id63(float2 position, out float2 base_uv, out float2 st)
{
    float2 uv = position * ShadowMapTextureSize_id148;
...
float FilterShadow_id58(float2 position, float positionDepth)
{
    ...
    {
        float3 kernel[16];
        float normalizationFactor = Get7x7FilterKernel_id64(base_uv, st, kernel);
...
float4 EvaluateSphericalHarmonics_id103(float3 sphericalColors[TOrder_id184 * TOrder_id184], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float3 GetShadowPositionOffset_id60(float offsetScale, float nDotL, float3 normal)
{
    ...
    return 2.0f * ShadowMapTextureTexelSize_id149.x * offsetScale * normalOffsetScale * normal;
}
float4 Compute_id193(inout PS_STREAMS streams, float3 direction)
{
    float alpha = streams.alphaRoughness_id70;
    float mipLevel = sqrt(alpha) * MipCount_id188;
    return CubeMap_id189.SampleLevel(LinearSampler_id113, direction, mipLevel);
}
float4 Compute_id188(float3 direction)
{
    return EvaluateSphericalHarmonics_id103(SphericalColors_id187, direction);
}
...
float3 ComputeShadow_id52(inout PS_STREAMS streams, float3 position, int lightIndex)
{
    ...
    streams.thicknessWS_id143 = tempThickness;
    return shadow;
}
void PrepareDirectLightCore_id51(inout PS_STREAMS streams, int lightIndex)
{
    streams.lightColor_id43 = Lights_id146[lightIndex].Color;
    streams.lightDirectionWS_id42 = -Lights_id146[lightIndex].DirectionWS;
}
void ResetStream_id122()
{
}
void AfterLightingAndShading_id217()
{
}
...
void PrepareEnvironmentLight_id203(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id188(sampleDirection).rgb * Intensity_id191 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id193(streams, sampleDirection).rgb * Intensity_id191 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id210(inout PS_STREAMS streams)
{
...
void PrepareDirectLight_id169(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.shadowColor_id142 = ComputeShadow_id87(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id44 = streams.lightColor_id43 * streams.lightAttenuation_id46 * streams.shadowColor_id142 * streams.NdotL_id49 * streams.lightDirectAmbientOcclusion_id50;
...
int GetLightCount_id173(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y >> 16;
}
int GetMaxLightCount_id172(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y >> 16;
}
...
void PrepareDirectLight_id156(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id49 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id42), 0.0001f);
    streams.shadowColor_id142 = ComputeShadow_id76(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id44 = streams.lightColor_id43 * streams.lightAttenuation_id46 * streams.shadowColor_id142 * streams.NdotL_id49 * streams.lightDirectAmbientOcclusion_id50;
    streams.lightSpecularColorNdotL_id45 = streams.lightColorNdotL_id44;
...
int GetLightCount_id161(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y & 0xFFFF;
}
int GetMaxLightCount_id160(inout PS_STREAMS streams)
{
    return streams.lightData_id173.y & 0xFFFF;
}
void PrepareDirectLights_id159(inout PS_STREAMS streams)
{
    PrepareLightData_id82(streams);
}
float3 ComputeDirectLightContribution_id209(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
...
void PrepareDirectLight_id132(inout PS_STREAMS streams, int lightIndex)
{
    ...
    streams.NdotL_id49 = max(dot(streams.normalWS_id19, streams.lightDirectionWS_id42), 0.0001f);
    streams.shadowColor_id142 = ComputeShadow_id52(streams, streams.PositionWS_id22.xyz, lightIndex);
    streams.lightColorNdotL_id44 = streams.lightColor_id43 * streams.lightAttenuation_id46 * streams.shadowColor_id142 * streams.NdotL_id49 * streams.lightDirectAmbientOcclusion_id50;
    streams.lightSpecularColorNdotL_id45 = streams.lightColorNdotL_id44;
...
int GetLightCount_id134()
{
    return LightCount_id144;
}
int GetMaxLightCount_id135()
{
    return TMaxLightCount_id145;
}
void PrepareDirectLights_id130()
{
}
void PrepareForLightingAndShading_id214()
{
}
void PrepareMaterialForLightingAndShading_id121(inout PS_STREAMS streams)
{
...
void ResetLightStream_id120(inout PS_STREAMS streams)
{
...
void Compute_id251(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id120(streams);
    PrepareMaterialForLightingAndShading_id121(streams);

    {
        PrepareForLightingAndShading_id214();
    }
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id130();
        const int maxLightCount = GetMaxLightCount_id135();
        int count = GetLightCount_id134();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id209(streams);
            }
        }
    }

    {
        PrepareDirectLights_id159(streams);
        const int maxLightCount = GetMaxLightCount_id160(streams);
        int count = GetLightCount_id161(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id172(streams);
        int count = GetLightCount_id173(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id210(streams);
        }
    }
    ...
    {
        AfterLightingAndShading_id217();
    }
}
void Compute_id235(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id207();
...
float4 Compute_id46()
{
    return MaterialIndex_id141;
}
float4 Shading_id34(inout PS_STREAMS streams)
{
    float4 Shading_1302570742 = Shading_id32(streams);
