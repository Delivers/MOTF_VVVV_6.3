...
@C    InputValue_id223 => ShaderFX.InputValueFloat4_Color.i1
@C    InputValue_id231 => ShaderFX.InputValueFloat.i2
...
//
#line 1334 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_9c8b9681ab4eeb916dd0a2662daaf5a6.hlsl"
...
@G    Pixel => f356261e1aeb849516c90abf590309c1
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float4 InputValue_id223;           // Offset:   32 Size:    16
//   float InputValue_id231;            // Offset:   48 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 1401 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_9c8b9681ab4eeb916dd0a2662daaf5a6.hlsl"
...
#line 464
  sample_c_lz_indexable(texture2d)(float,float,float,float) r5.w, r14.xyxx, t1.xxxx, s1, r8.z  // r5.w <- <SampleTextureAndCompare_id68 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id68 return value>
...
#line 464
  sample_c_lz_indexable(texture2d)(float,float,float,float) r8.w, r16.xyxx, t1.xxxx, s1, r8.z  // r8.w <- <SampleTextureAndCompare_id68 return value>

#line 552
  mad r5.w, r6.z, r8.w, r5.w

#line 464
  sample_c_lz_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t1.xxxx, s1, r8.z  // r6.z <- <SampleTextureAndCompare_id68 return value>
...
#line 464
      sample_c_lz_indexable(texture2d)(float,float,float,float) r3.w, r14.xyxx, t1.xxxx, s1, r7.z  // r3.w <- <SampleTextureAndCompare_id68 return value>
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r14.zwzz, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id68 return value>
...
#line 464
      sample_c_lz_indexable(texture2d)(float,float,float,float) r4.w, r16.xyxx, t1.xxxx, s1, r7.z  // r4.w <- <SampleTextureAndCompare_id68 return value>
...
#line 522
  ...
  mul r3.w, r3.w, r3.w
  mul r2.x, r2.x, r3.w
  mad r8.xyz, r8.xyzx, r2.xxxx, r4.xyzx  // r8.x <- <FresnelSchlick_id160 return value>.x; r8.y <- <FresnelSchlick_id160 return value>.y; r8.z <- <FresnelSchlick_id160 return value>.z
...
#line 518
  ...
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id176 return value>
  mad r2.x, r6.y, r3.w, r2.x
  div r2.x, r6.y, r2.x  // r2.x <- <VisibilityhSchlickGGX_id176 return value>

#line 628
  mul r2.x, r2.x, r4.w
  mul r1.w, r6.y, r1.w
  div r1.w, r2.x, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id178 return value>
...
#line 624
  ...
  div r0.z, r2.x, r0.z  // r0.z <- <NormalDistributionGGX_id190 return value>
...
#line 983
  mul r7.xyz, r7.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000)  // r7.x <- <ComputeDirectLightContribution_id519 return value>.x; r7.y <- <ComputeDirectLightContribution_id519 return value>.y; r7.z <- <ComputeDirectLightContribution_id519 return value>.z
...
#line 970
and r0.z, r0.y, l(0x0000ffff)  // r0.z <- <GetMaxLightCount_id234 return value>
...
mov r10.w, r4.x  // r10.w <- streams.matSpecularVisible_id71.x
mov r11.xy, r4.yzyy  // r11.x <- streams.matSpecularVisible_id71.y; r11.y <- streams.matSpecularVisible_id71.z
mov r11.z, r0.w  // r11.z <- streams.alphaRoughness_id70
...
#line 522
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r13.xyz, r15.xyzx, r4.wwww, r13.xyzx  // r13.x <- <FresnelSchlick_id160 return value>.x; r13.y <- <FresnelSchlick_id160 return value>.y; r13.z <- <FresnelSchlick_id160 return value>.z

#line 517
  mul r4.w, r11.z, l(0.500000)  // r4.w <- k

#line 518
  mad r5.w, -r11.z, l(0.500000), l(1.000000)
  mad r11.w, r3.w, r5.w, r4.w
  div r11.w, r3.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id176 return value>
  mad r4.w, r6.w, r5.w, r4.w
  div r4.w, r6.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id176 return value>

#line 628
  mul r4.w, r4.w, r11.w
  mul r3.w, r6.w, r3.w
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id178 return value>

#line 622
  mul r4.w, r11.z, r11.z  // r4.w <- alphaR2

#line 623
  mul r2.w, r2.w, r2.w
  mad r5.w, r11.z, r11.z, l(-1.000000)
...
#line 624
  ...
  div r2.w, r4.w, r2.w  // r2.w <- <NormalDistributionGGX_id190 return value>
...
#line 522
  ...
  mul r4.w, r4.w, r4.w
  mul r3.w, r3.w, r4.w
  mad r16.xyz, r16.xyzx, r3.wwww, r11.xyzx  // r16.x <- <FresnelSchlick_id160 return value>.x; r16.y <- <FresnelSchlick_id160 return value>.y; r16.z <- <FresnelSchlick_id160 return value>.z
...
#line 518
  ...
  div r5.w, r2.w, r5.w  // r5.w <- <VisibilityhSchlickGGX_id176 return value>
  mad r3.w, r7.w, r4.w, r3.w
  div r3.w, r7.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id176 return value>

#line 628
  mul r3.w, r3.w, r5.w
  mul r2.w, r7.w, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id178 return value>

#line 622
  mul r3.w, r7.x, r7.x  // r3.w <- alphaR2
...
#line 624
  ...
  div r1.w, r3.w, r1.w  // r1.w <- <NormalDistributionGGX_id190 return value>
...
#line 725
mad r0.yzw, r4.xxyz, r0.yyyy, r0.zzzz  // r0.y <- <Compute_id341 return value>.x; r0.z <- <Compute_id341 return value>.y; r0.w <- <Compute_id341 return value>.z

#line 917
mul r2.xyz, r0.yzwy, cb2[88].xyzx  // r2.x <- <ComputeEnvironmentLightContribution_id520 return value>.x; r2.y <- <ComputeEnvironmentLightContribution_id520 return value>.y; r2.z <- <ComputeEnvironmentLightContribution_id520 return value>.z
...
#line 710
sample_l_indexable(texturecube)(float,float,float,float) r1.xyz, r3.xyzx, t6.xyzw, s0, r0.x  // r1.x <- <Compute_id267 return value>.x; r1.y <- <Compute_id267 return value>.y; r1.z <- <Compute_id267 return value>.z
...
#line 1211
mad r0.xyz, r13.xyzx, l(3.141593, 3.141593, 3.141593, 0.000000), r0.xyzx  // r0.x <- streams.shadingColor_id73.x; r0.y <- streams.shadingColor_id73.y; r0.z <- streams.shadingColor_id73.z
...
const static bool TUseAlphaFromEmissive_id252 = true;
struct PS_STREAMS 
{
...
{
    streams.Input_4_id230 = Compute_id329();
}
void Compute_id320(inout PS_STREAMS streams)
{
    streams.Input_3_id222 = Compute_id317();
}
void Compute_id308(inout PS_STREAMS streams)
{
    streams.Input_2_id211 = Compute_id305();
}
void Compute_id296(inout PS_STREAMS streams)
{
    streams.Input_1_id202 = Compute_id293();
}
void Compute_id284(inout PS_STREAMS streams)
{
    streams.Input_0_id194 = Compute_id281();
}
float4 EvaluateSphericalHarmonics_id106(float3 sphericalColors[TOrder_id184 * TOrder_id184], float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float NormalDistributionGGX_id190(float alphaR, float nDotH)
{
...
{
    return EvaluateSphericalHarmonics_id106(SphericalColors_id187, direction);
}
...
float3 Compute_id341(float3 specularColor, float alphaR, float nDotV)
{
    float glossiness = 1.0f - sqrt(alphaR);
    float4 environmentLightingDFG = EnvironmentLightingDFG_LUT_id243.SampleLevel(LinearSampler_id122, float2(glossiness, nDotV), 0);
...
{
    return NormalDistributionGGX_id190(streams.alphaRoughness_id70, streams.NdotH_id76);
}
float Compute_id403(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id178(streams.alphaRoughness_id70, streams.NdotL_id49, streams.NdotV_id72);
}
float3 Compute_id373(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id166(f0, streams.LdotH_id77);
}
...
void PrepareEnvironmentLight_id277(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id47 = Compute_id262(sampleDirection).rgb * Intensity_id191 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id48 = Compute_id267(streams, sampleDirection).rgb * Intensity_id191 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeEnvironmentLightContribution_id520(inout PS_STREAMS streams)
{
    ...
    return Compute_id341(specularColor, streams.alphaRoughness_id70, streams.NdotV_id72) * streams.envLightSpecularColor_id48;
}
float3 ComputeEnvironmentLightContribution_id464(inout PS_STREAMS streams)
{
...
{
    float3 specularColor = streams.matSpecularVisible_id71;
    float3 fresnel = Compute_id373(streams, specularColor);
    float geometricShadowing = Compute_id403(streams);
    float normalDistribution = Compute_id433(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightSpecularColorNdotL_id45 * streams.matDiffuseSpecularAlphaBlend_id65.y;
}
float3 ComputeDirectLightContribution_id463(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id69;
    return diffuseColor / PI_id242 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id65.x;
}
...
{
    float x = Compute_id338(streams);
    return float4(x, x, x, x);
}
float4 Compute_id328(inout PS_STREAMS streams)
{
...
void Compute_id561(inout PS_STREAMS streams)
{
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id463(streams);
            }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id464(streams);
        }
    ...
    streams.shadingColor_id73 += directLightingContribution * PI_id242 + environmentLightingContribution;
...
{
    streams.matEmissiveIntensity_id63 = Compute_id340(streams).r;
}
void Compute_id540(inout PS_STREAMS streams)
{
    streams.matEmissive_id62 = Compute_id328(streams).rgba;
}
