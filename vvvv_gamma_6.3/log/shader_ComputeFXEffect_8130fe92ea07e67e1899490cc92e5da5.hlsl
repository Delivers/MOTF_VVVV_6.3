...
@P EffectNodeBase.EffectNodeBaseShader: mixin ComputeFXGraph [{Root = mixin ComputeOrder [{Computes = [Shader_229293572]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@C    input_232424229_id15 => input_232424229
@C    input_192517857_id16 => input_192517857
***************************
******  Resources    ******
***************************
@R    DynamicBufferInput_58384011_id12 => DynamicBufferInput_58384011 [Stage: Compute, Slot: (0-0)]
@R    DynamicBufferInput_2401980701_id13 => DynamicBufferInput_2401980701 [Stage: Compute, Slot: (1-1)]
...
@S    Shader_229293572 => 11de2e4cb656a8445c93838b8ca19f0b
***************************
*****     Stages      *****
***************************
@G    Compute => 005b6534f58134c804c6192eace3c295
//
...
//   float input_232424229_id15;        // Offset:   16 Size:     4 [unused]
//   float3 input_192517857_id16;       // Offset:   20 Size:    12 [unused]
//
// }
//
...
// }
//
// Resource bind info for DynamicBufferInput_2401980701_id13
// {
//
...
// DynamicBufferInput_2401980701_id13        UAV  struct      append             u1      1 
...
//
#line 50 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_ComputeFXEffect_8130fe92ea07e67e1899490cc92e5da5.hlsl"
ult r0.x, vThreadID.x, cb0[0].w
if_nz r0.x

#line 51
  ld_structured_indexable(structured_buffer, stride=124)(mixed,mixed,mixed,mixed) r0.xy, vThreadID.x, l(0), u0.xyxx  // r0.x <- getBuffer_2_2805507595.Age; r0.y <- getBuffer_2_2805507595.LifeTime
...
AppendStructuredBuffer<int> DynamicBufferInput_2401980701_id13;
