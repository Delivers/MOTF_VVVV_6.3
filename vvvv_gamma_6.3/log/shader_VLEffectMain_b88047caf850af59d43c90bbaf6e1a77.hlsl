...
@P Lighting.DirectLightGroups: mixin LightDirectionalGroup<1>, ShadowMapReceiverDirectional<1,1,true,true,false,false>, ShadowMapFilterPcf<PerView.Lighting,5>, LightClusteredPointGroup, LightClusteredSpotGroup
...
//   float3 AmbientLight_id182;         // Offset:  736 Size:    12 [unused]
//   float3 SphericalColors_id187[9];   // Offset:  752 Size:   140 [unused]
//   float MipCount_id188;              // Offset:  892 Size:     4 [unused]
//   float4x4 SkyMatrix_id190;          // Offset:  896 Size:    64 [unused]
//   float Intensity_id191;             // Offset:  960 Size:     4 [unused]
...
//
#line 1039 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_b88047caf850af59d43c90bbaf6e1a77.hlsl"
...
@G    Pixel => d0a89179a4a7e667b25e6f1783df8689
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//   float3 AmbientLight_id182;         // Offset:  736 Size:    12
//   float3 SphericalColors_id187[9];   // Offset:  752 Size:   140
//   float MipCount_id188;              // Offset:  892 Size:     4 [unused]
//   float4x4 SkyMatrix_id190;          // Offset:  896 Size:    64
//   float Intensity_id191;             // Offset:  960 Size:     4
//   float4 _padding_PerView_Lighting;  // Offset:  976 Size:    16 [unused]
//
// }
//
...
//
#line 1106 "C:\Projects\MOTF\MOTF_VVVV_6.3\vvvv_gamma_6.3\log\shader_VLEffectMain_b88047caf850af59d43c90bbaf6e1a77.hlsl"
...
#line 573
  ...
  max r0.w, r0.w, l(0.000000)  // r0.w <- normalOffsetScale

#line 574
  mul r1.w, cb2[28].z, cb2[43].x
  dp2 r0.w, r1.wwww, r0.wwww

#line 683
  mad r2.xyz, r0.wwww, r1.xyzx, v0.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 566
  mov r2.w, l(1.000000)
  dp4 r3.x, r2.xyzw, cb2[29].xyzw  // r3.x <- shadowPosition.x
  dp4 r3.y, r2.xyzw, cb2[30].xyzw  // r3.y <- shadowPosition.y
  dp4 r0.w, r2.xyzw, cb2[31].xyzw  // r0.w <- shadowPosition.z
  dp4 r1.w, r2.xyzw, cb2[32].xyzw  // r1.w <- shadowPosition.w

#line 567
  add r3.z, r0.w, -cb2[42].x  // r3.z <- shadowPosition.z

#line 568
  div r2.xyz, r3.xyzx, r1.wwww  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 457
  mad r2.xy, r2.xyxx, cb2[28].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r3.xy, r2.xyxx  // r3.x <- base_uv.x; r3.y <- base_uv.y

#line 458
  add r2.xy, r2.xyxx, -r3.xyxx  // r2.x <- st.x; r2.y <- st.y

#line 459
  add r3.xy, r3.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)

#line 460
  mul r3.xy, r3.xyxx, cb2[28].zwzz

#line 321
  mad r3.zw, -r2.yyyx, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r3.z <- uvW0.y; r3.w <- uvW0.x

#line 323
  mad r4.xy, r2.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r4.x <- uvW2.x; r4.y <- uvW2.y

#line 324
  mad r4.zw, -r2.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r4.zw, r4.zzzw, r3.wwwz
  add r5.xw, r4.zzzw, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r5.x <- uv0.x; r5.w <- uv0.y

#line 325
  add r4.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  mul r5.yz, r4.wwzw, l(0.000000, 0.142857, 0.142857, 0.000000)  // r5.y <- uv1.y; r5.z <- uv1.x

#line 326
  div r2.xy, r2.xyxx, r4.xyxx
  add r6.xy, r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r6.x <- uv2.x; r6.y <- uv2.y

#line 327
  mul r0.w, r3.z, r3.w

#line 328
  mad r7.xyzw, r5.xwzw, cb2[28].zwzw, r3.xyxy
...
#line 331
  mad r8.xyzw, r5.xyzy, cb2[28].zwzw, r3.xyxy

#line 332
  mad r9.xyzw, r6.xzxw, cb2[28].zwzw, r3.xyxy
...
#line 334
  mad r5.xyzw, r5.xyzy, cb2[28].zwzw, r3.xyxy
  mul r4.zw, r4.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 335
  mad r3.xy, r6.xyxx, cb2[28].zwzz, r3.xyxx
  mul r1.w, r4.y, r4.x

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.w, r7.xyxx, t0.xxxx, s0, r2.z  // r2.w <- <SampleTextureAndCompare_id62 return value>
  sample_c_lz_indexable(texture2d)(float,float,float,float) r4.x, r7.zwzz, t0.xxxx, s0, r2.z  // r4.x <- <SampleTextureAndCompare_id62 return value>

#line 511
  mul r2.x, r2.x, r4.x
  mad r0.w, r0.w, r2.w, r2.x  // r0.w <- shadow

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r9.xyxx, t0.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id62 return value>

#line 511
  mad r0.w, r3.z, r2.x, r0.w

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r8.xyxx, t0.xxxx, s0, r2.z

#line 511
  mad r0.w, r2.y, r2.x, r0.w

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r8.zwzz, t0.xxxx, s0, r2.z

#line 511
  mad r0.w, r2.x, l(49.000000), r0.w

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r9.zwzz, t0.xxxx, s0, r2.z

#line 511
  mad r0.w, r4.z, r2.x, r0.w

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r5.xyxx, t0.xxxx, s0, r2.z

#line 511
  mad r0.w, r3.w, r2.x, r0.w

#line 452
  sample_c_lz_indexable(texture2d)(float,float,float,float) r2.x, r5.zwzz, t0.xxxx, s0, r2.z

#line 511
  mad r0.w, r4.w, r2.x, r0.w
...
#line 812
  mul r2.xyz, r0.wwww, cb2[27].xyzx
...
#line 730
dp3 r0.x, r1.xyzx, cb2[56].xyzx  // r0.x <- sampleDirection.x
dp3 r0.y, r1.xyzx, cb2[57].xyzx  // r0.y <- sampleDirection.y
dp3 r0.z, r1.xyzx, cb2[58].xyzx  // r0.z <- sampleDirection.z
...
#line 528
mad r1.yzw, cb2[48].xxyz, r0.yyyy, cb2[47].xxyz  // r1.y <- color.x; r1.z <- color.y; r1.w <- color.z

#line 529
mad r1.yzw, cb2[49].xxyz, -r0.zzzz, r1.yyzw

#line 530
mad r1.yzw, cb2[50].xxyz, r0.xxxx, r1.yyzw

#line 533
mul r2.xyz, r0.yyyy, cb2[51].xyzx
mad r1.yzw, r2.xxyz, r0.xxxx, r1.yyzw

#line 534
mul r2.xyz, r0.yyyy, cb2[52].xyzx
mad r1.yzw, r2.xxyz, -r0.zzzz, r1.yyzw

#line 535
mad r0.y, r1.x, l(3.000000), l(-1.000000)
mad r1.xyz, cb2[53].xyzx, r0.yyyy, r1.yzwy  // r1.x <- color.x; r1.y <- color.y; r1.z <- color.z

#line 536
mul r2.xyz, r0.xxxx, cb2[54].xyzx
mad r1.xyz, r2.xyzx, -r0.zzzz, r1.xyzx

#line 537
mad r0.x, r0.x, r0.x, -r0.w
mad r0.xyz, cb2[55].xyzx, r0.xxxx, r1.xyzx  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z

#line 732
mul r0.xyz, r0.xyzx, cb2[60].xxxx  // r0.x <- streams.envLightDiffuseColor_id47.x; r0.y <- streams.envLightDiffuseColor_id47.y; r0.z <- streams.envLightDiffuseColor_id47.z
...
#line 952
mad r0.xyz, cb1[0].xyzx, cb2[46].xyzx, r0.xyzx  // r0.x <- environmentLightingContribution.x; r0.y <- environmentLightingContribution.y; r0.z <- environmentLightingContribution.z
